...
function displayResults() {
  ...
  for (var page = 0; page < numberOfPages; page++) {
    ...
    for (var j = start; j < end; j++) {
      ...
      ansContent = ans.image ? "<img src='" + ans.image + "' alt='Answer Image' style='width: 250px; height: 120px;'>" : getOptionLabel(ans);

      // Display the image or text label for given answer
      givenContent = givenAnswer ? (givenAnswer.image ? "<img src='" + givenAnswer.image + "' alt='Given Answer Image' style='width: 250px; height: 120px;'>" : getOptionLabel(givenAnswer)) : "Not Answered";
